  ...
  connections: {
    ...
    */
    ...
    accounting: {
      client: 'mysql',
      connection: {
        host: Env.get('MYSQL_ACT_HOST'),
        port: Env.get('MYSQL_ACT_PORT'),
        user: Env.get('MYSQL_ACT_USER'),
        password: Env.get('MYSQL_ACT_PASSWORD', ''),
        database: Env.get('MYSQL_ACT_DB_NAME'),
      },
      healthCheck: false,
			debug: false,
    },
